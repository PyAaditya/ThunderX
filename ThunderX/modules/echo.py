...
from ThunderX.sql.echo_sql import addecho, is_echo, remove_echo
from ThunderX.data import THUNDERX
  ...
  if event.sender_id in SUDO_USERS:
     if event.reply_to_msg_id is not None:
        ...
        if int(user_id) in THUNDERX:
            await event.reply("» ɴᴏ, ᴛʜɪꜱ ɢᴜʏ ɪꜱ ᴛʜᴜɴᴅᴇʀx'ꜱ ᴏᴡɴᴇʀ", parse_mode=None, link_preview=None)
